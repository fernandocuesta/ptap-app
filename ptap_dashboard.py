        ...
        if not ultimos_30.empty:
            if loc_norm in SOLO_CLORO_LOCACIONES_NORM:
                ...
                for param, color, rango, subtitulo in [
                    ...
                    ("Turbidez (NTU)", "orange", [(0, 5, "green", 0.15), (5, 10, "yellow", 0.13), (10, 15, "red", 0.09)], "Turbidez (NTU)"),
                    ("Cloro Residual (mg/L)", "purple", [(0.5, 1.5, "green", 0.15), (0.2, 0.5, "yellow", 0.13), (1.5, 2.0, "yellow", 0.13), (0, 0.2, "red", 0.07), (2.0, 3, "red", 0.07)], "Cloro Residual (mg/L)")
                ]:
